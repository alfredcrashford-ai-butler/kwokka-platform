...
<script lang="ts">
  ...
  export default class UiResponsiveImage extends Vue {
    ...
    public mode?: UiResponsiveImageBackgroundMode;

    @Prop({ default: false })
    public draggable?: boolean;

    public get backgroundModeClass() {
      const mode = this.mode || 'contain';
      return `ui-responsive-image_mode-${mode}`;
    }
  }
</script>
